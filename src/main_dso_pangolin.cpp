...
int main(int argc, char **argv) {
	...
	// TODO Read extrinsics from config.
	// Relative to drone body.  Numbers take from EuRoC MAV MH_01_easy. Camera baseline is about 110mm.
	// These extrinsics for EuRoC seem to be the positions of the cameras from the drone base, not the translation of a world point to the camera co-ord system...
	...
	SE3 leftToRight = SE3(rightExtrinsics).inverse() * SE3(leftExtrinsics);
...
//	leftToRight.translation()[0] = 0.11; // EuRoC camera baseline is 110mm.
	...
	std::thread runthread([&]() {
		...
		printf("\n======================"
				...
				1000 / (MilliSecondsTakenSingle / numSecondsProcessed), 1000 / (MilliSecondsTakenMT / numSecondsProcessed));
